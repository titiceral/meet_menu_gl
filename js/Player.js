...
Player.prototype = {
    _initCamera : function(scene, canvas) {
        ...
        this.camera = new BABYLON.ArcRotateCamera("camera",-Math.PI/2.0, Math.PI/2.0 *0.9, MEET_CAMERA_RADIUS, new BABYLON.Vector3(0,12,0), scene);// new BABYLON.Vector3(0, 30, -50), scene);
