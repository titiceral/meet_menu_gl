...
class ActionDoubleButtonImg extends IButtonImg {
  ...
  constructor(
    ...
    private strTexturePathClicked: string,
  ...
  OnClicked(): void {
    // avoid click still animation not ended
  ...
  // callback
  OnClickedDone(sender: ActionDoubleButtonImg): void {
    // ActionDoubleButtonImg should be this
    if (sender.isClicked) {
