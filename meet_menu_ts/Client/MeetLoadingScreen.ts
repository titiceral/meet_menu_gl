class MeetLoadingScreen implements BABYLON.ILoadingScreen {
   ...
   // public static DefaultSpinnerUrl = "";
     ...
     */
    constructor(private _renderingCanvas: HTMLCanvasElement,
          private _loadingDivBackgroundColor = "black",
          public defaultLogoUrl = "",
          public defaultSpinnerUrl = "") {
