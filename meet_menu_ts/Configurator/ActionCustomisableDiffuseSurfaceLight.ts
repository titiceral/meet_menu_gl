...
class ActionCustomisableDiffuseSurfaceLight extends IInitialisable
  implements IActionSender, IGLLight, ICustomisable {
  ...
  constructor(
    ...
    this._surfaceDiffuserMaterial = new GLBabylonMaterialDiffuser(
      surfaceDiffuserMaterial as BABYLON.StandardMaterial
    );
    this._surfaceLightMaterial = new GLBabylonMaterial(
      surfaceLightMaterial as BABYLON.StandardMaterial
    );
  ...
  InitiliseCallback(
    eventOnActiveHandlerEndIn: (sender: any) => void,
    sender: any
  ) {
  ...
  _setCustomisable(strKey: string): void {
    ...
    if (selectedProperties != null) {
      this._surfaceDiffuserMaterial.CopyFrom(
        selectedProperties._diffuserProperties
      );

      this._surfaceDiffuserMaterial.SetDiffuseTexture(
        selectedProperties._diffuserProperties.diffuseTexture,
        selectedProperties._diffuserProperties.uScaleTexture,
        selectedProperties._diffuserProperties.vScaleTexture,
        selectedProperties._diffuserProperties.uOffsetTexture,
        selectedProperties._diffuserProperties.vOffsetTexture
      );
      this._surfaceDiffuserMaterial.SetEmissiveTexture(
        selectedProperties._diffuserProperties.emissiveTexture,
        selectedProperties._diffuserProperties.uScaleTexture,
        selectedProperties._diffuserProperties.vScaleTexture,
        selectedProperties._diffuserProperties.uOffsetTexture,
        selectedProperties._diffuserProperties.vOffsetTexture
      );
      this._surfaceDiffuserMaterial.SetOpacityTexture(
        selectedProperties._diffuserProperties.opacityTexture,
        selectedProperties._diffuserProperties.uScaleTexture,
        selectedProperties._diffuserProperties.vScaleTexture,
        selectedProperties._diffuserProperties.uOffsetTexture,
        selectedProperties._diffuserProperties.vOffsetTexture
  ...
  _AnimatedSunToMoonLights(minFrame = 0, maxFrame: number = 100): void {
    ...
    var animationSunToMoonLight = new BABYLON.Animation(
      "animationSunToMoonLight",
      "intensity",
      MEET_ANIMATION_SPEED,
    ...
    (this._surfaceLight as GLBabylonLight)._gllight.animations.push(
      animationSunToMoonLight
    );

    // tissus
    // Light Tissu emissive color
    var animSunToMoonTissu = new BABYLON.Animation(
      "animSunToMoonTissu",
      "emissiveColor",
      MEET_ANIMATION_SPEED,
    ...
    keysSunToMoonTissu.push({
      frame: MEET_ANIMATION_LIGHT_ON_FRAME + 5,
      value: ColorRGBBabylon.FromColorRGB(
        this._surfaceDiffuserMaterial.emissiveColor
      ),
    });
    keysSunToMoonTissu.push({
      frame: 100,
    ...
    (this
      ._surfaceDiffuserMaterial as GLBabylonMaterialDiffuser).glmaterial.animations = [];
    (this
      ._surfaceDiffuserMaterial as GLBabylonMaterialDiffuser).glmaterial.animations.push(
      animSunToMoonTissu
    );

    // transparence du tissu lorsque la lumière s'allume
    var animSunToMoonTissuTransparency = new BABYLON.Animation(
      "animSunToMoonTissuTransparency",
      "alpha",
      MEET_ANIMATION_SPEED,
      BABYLON.Animation.ANIMATIONTYPE_FLOAT,
      BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT
    ...
    if (
      (this._surfaceDiffuserMaterial as GLBabylonMaterialDiffuser).glmaterial
        .emissiveTexture != null
    ) {
      var animEmissivetextureVOffset = new BABYLON.Animation(
        "animEmissivetextureVOffset",
        "vOffset",
        MEET_ANIMATION_SPEED,
        BABYLON.Animation.ANIMATIONTYPE_FLOAT,
        BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT
      );
      var animEmissivetextureUOffset = new BABYLON.Animation(
        "animEmissivetextureUOffset",
        "uOffset",
        MEET_ANIMATION_SPEED,
        BABYLON.Animation.ANIMATIONTYPE_FLOAT,
        BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT
      ...
      keymissivetextureClampU.push({
        frame: MEET_ANIMATION_LIGHT_ON_FRAME + 1,
        value: this._surfaceDiffuserMaterial.uOffsetTexture, //0,
      });
      keymissivetextureClampU.push({
        frame: 100,
        value: this._surfaceDiffuserMaterial.uOffsetTexture, //0,
      ...
      console.log(
        "uOffsetTexture " + this._surfaceDiffuserMaterial.uOffsetTexture
      );
      ...
      keymissivetextureClampV.push({
        frame: MEET_ANIMATION_LIGHT_ON_FRAME + 1,
        value: this._surfaceDiffuserMaterial.vOffsetTexture, //-1,
      });
      keymissivetextureClampV.push({
        frame: 100,
        value: this._surfaceDiffuserMaterial.vOffsetTexture, //-1,
      ...
      ((this._surfaceDiffuserMaterial as GLBabylonMaterialDiffuser).glmaterial
        .emissiveTexture as BABYLON.Texture).animations = [];
      ((this._surfaceDiffuserMaterial as GLBabylonMaterialDiffuser).glmaterial
        .emissiveTexture as BABYLON.Texture).animations.push(
        animEmissivetextureUOffset
      );
    ...
    // _lightMesh ->
    var animSunToMoonLightMesh = new BABYLON.Animation(
      "animSunToMoonLightMesh",
      "emissiveColor",
      MEET_ANIMATION_SPEED,
      BABYLON.Animation.ANIMATIONTYPE_COLOR3,
      BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT
    ...
    (this
      ._surfaceLightMaterial as GLBabylonMaterial).glmaterial.animations = [];
    (this
      ._surfaceLightMaterial as GLBabylonMaterial).glmaterial.animations.push(
      animSunToMoonLightMesh
    );
...
*/
    this._scene.scene.beginAnimation(
      (this._surfaceDiffuserMaterial as GLBabylonMaterialDiffuser).glmaterial,
      minFrame,
      maxFrame,
      true
    ...
    this._scene.scene.beginAnimation(
      (this._surfaceLightMaterial as GLBabylonMaterial).glmaterial,
      minFrame,
      maxFrame,
      true
    );
    this._scene.scene.beginAnimation(
      (this._surfaceLight as GLBabylonLight)._gllight,
      minFrame,
      maxFrame,
      false,
      1.0,
  ...
  _AnimatedMoonToSunLights(): void {
    // intensité de la veilleuse -> allume la veilleuse
    var animationMoonToSunLight = new BABYLON.Animation(
      "animationMoonToSunLight",
      "intensity",
      MEET_ANIMATION_SPEED,
      BABYLON.Animation.ANIMATIONTYPE_FLOAT,
      BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT
    ...
    // tissus
    // Light Tissu emissive color
    var animMoonToSunTissu = new BABYLON.Animation(
      "animMoonToSunTissu",
      "emissiveColor",
      MEET_ANIMATION_SPEED,
      BABYLON.Animation.ANIMATIONTYPE_COLOR3,
    ...
    if (
      ...
      keymissivetextureClampV.push({
        frame: MEET_ANIMATION_LIGHT_ON_FRAME,
        value: this._surfaceDiffuserMaterial.vOffsetTexture, //0,,
      });
      keymissivetextureClampV.push({
        frame: MEET_ANIMATION_LIGHT_ON_FRAME + 1,
        value: -20,
    ...
    // transparence du tissu lorsque la lumière s'allume
    var animMoonToSunTissuTransparency = new BABYLON.Animation(
      "animMoonToSunTissuTransparency",
      "alpha",
      MEET_ANIMATION_SPEED,
      BABYLON.Animation.ANIMATIONTYPE_FLOAT,
      BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT
    ...
    // _lightMesh ->
    var animMoonToSunLightMesh = new BABYLON.Animation(
      "animMoonToSunLightMesh",
      "emissiveColor",
      MEET_ANIMATION_SPEED,
      BABYLON.Animation.ANIMATIONTYPE_COLOR3,
      BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT
